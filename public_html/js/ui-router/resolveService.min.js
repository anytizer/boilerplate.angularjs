...
</code></td></tr><tr><td id="L7" class="css-a4x74f"><span>7</span></td><td id="LC7" class="css-1dcdqdg"><code>!<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">e,r</span>)</span>{<span class="code-string">"object"</span>==<span class="code-keyword">typeof</span> exports&amp;&amp;<span class="code-string">"undefined"</span>!=<span class="code-keyword">typeof</span> <span class="code-built_in">module</span>?r(exports,<span class="code-built_in">require</span>(<span class="code-string">"@uirouter/core"</span>),<span class="code-built_in">require</span>(<span class="code-string">"angular"</span>)):<span class="code-string">"function"</span>==<span class="code-keyword">typeof</span> define&amp;&amp;define.amd?define([<span class="code-string">"exports"</span>,<span class="code-string">"@uirouter/core"</span>,<span class="code-string">"angular"</span>],r):r((e=e||self)[<span class="code-string">"@uirouter/angularjs-resolve-service"</span>]={},e[<span class="code-string">"@uirouter/core"</span>],e.angular)}(<span class="code-keyword">this</span>,<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">e,s,r</span>)</span>{<span class="code-string">"use strict"</span>;<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">t</span>(<span class="code-params"></span>)</span>{<span class="code-keyword">return</span> o}<span class="code-keyword">var</span> o={<span class="code-attr">resolve</span>:<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">e,o,r</span>)</span>{<span class="code-keyword">void</span> <span class="code-number">0</span>===o&amp;&amp;(o={});<span class="code-keyword">var</span> n=<span class="code-keyword">new</span> s.PathNode(<span class="code-keyword">new</span> s.StateObject({<span class="code-attr">params</span>:{},<span class="code-attr">resolvables</span>:[]})),u=<span class="code-keyword">new</span> s.PathNode(<span class="code-keyword">new</span> s.StateObject({<span class="code-attr">params</span>:{},<span class="code-attr">resolvables</span>:[]})),a=<span class="code-keyword">new</span> s.ResolveContext([n,u]);a.addResolvables(s.resolvablesBuilder({<span class="code-attr">resolve</span>:e}),u.state);<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">t</span>(<span class="code-params">e</span>)</span>{<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">r</span>(<span class="code-params">e</span>)</span>{<span class="code-keyword">return</span> s.resolvablesBuilder({<span class="code-attr">resolve</span>:s.mapObj(e,<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">e</span>)</span>{<span class="code-keyword">return</span> <span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{<span class="code-keyword">return</span> e}})})}<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">t</span>(<span class="code-params">e,r</span>)</span>{<span class="code-keyword">return</span> e[r.token]=r.value,e}<span class="code-keyword">return</span> a.addResolvables(r(e),n.state),a.addResolvables(r(o),u.state),a.resolvePath().then(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">e</span>)</span>{<span class="code-keyword">return</span> e.reduce(t,{})})}<span class="code-keyword">return</span> r?r.then(t):t({})}};r.module(<span class="code-string">"ui.router"</span>).factory(<span class="code-string">"$resolve"</span>,t),e.resolveFactory=t,<span class="code-built_in">Object</span>.defineProperty(e,<span class="code-string">"__esModule"</span>,{<span class="code-attr">value</span>:!<span class="code-number">0</span>})});
</code></td></tr><tr><td id="L8" class="css-a4x74f"><span>8</span></td><td id="LC8" class="css-1dcdqdg"><code><span class="code-comment">//# sourceMappingURL=resolveService.min.js.map</span>
