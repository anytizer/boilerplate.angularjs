...
gtag('js', new Date());
gtag('config', 'UA-140352188-1');</script><meta charSet="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/><meta name="description" content="The CDN for @uirouter/angularjs"/><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1"/><meta name="timestamp" content="2020-05-01T23:18:07.344Z"/><link rel="shortcut icon" href="/favicon.ico"/><title>UNPKG - @uirouter/angularjs</title><script>window.Promise || document.write('\x3Cscript src="/es6-promise@4.2.5/dist/es6-promise.min.js">\x3C/script>\x3Cscript>ES6Promise.polyfill()\x3C/script>')</script><script>window.fetch || document.write('\x3Cscript src="/whatwg-fetch@3.0.0/dist/fetch.umd.js">\x3C/script>')</script><script>window.__DATA__ = {"packageName":"@uirouter/angularjs","packageVersion":"1.0.26","availableVersions":["0.2.8","0.2.10","0.2.11","0.2.13","0.2.14","0.2.15","0.2.16","0.2.17","0.2.18","0.3.0","0.3.1","0.3.2","0.4.0","0.4.1","0.4.2","0.4.3","1.0.0","1.0.1","1.0.3","1.0.4","1.0.5-SNAPSHOT.20170711","1.0.5","1.0.6-SNAPSHOT.20170812","1.0.6","1.0.7","1.0.8","1.0.9","1.0.10","1.0.11","1.0.12","1.0.13","1.0.14","1.0.15","1.0.16","1.0.17","1.0.18","1.0.19","1.0.20","1.0.21","1.0.22","1.0.23","1.0.24","1.0.25","1.0.26"],"filename":"/release/stateEvents.min.js","target":{"path":"/release/stateEvents.min.js","type":"file","details":{"contentType":"application/javascript","integrity":"sha384-JfqnsBDRKL84J+w2ARF5UhR4un8O/D6ZFZEVFQe9wq6o/hMlto8pDK7CzIIrWA3Y","language":"JavaScript","size":3030,"uri":null,"highlights":["<span class=\"code-comment\">/**\n</span>","<span class=\"code-comment\"> * State-based routing for AngularJS 1.x\n</span>","<span class=\"code-comment\"> * @version v1.0.26\n</span>","<span class=\"code-comment\"> * @link https://ui-router.github.io\n</span>","<span class=\"code-comment\"> * @license MIT License, http://www.opensource.org/licenses/MIT\n</span>","<span class=\"code-comment\"> */</span>\n","!<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">t,e</span>)</span>{<span class=\"code-string\">\"object\"</span>==<span class=\"code-keyword\">typeof</span> exports&amp;&amp;<span class=\"code-string\">\"undefined\"</span>!=<span class=\"code-keyword\">typeof</span> <span class=\"code-built_in\">module</span>?e(exports,<span class=\"code-built_in\">require</span>(<span class=\"code-string\">\"angular\"</span>)):<span class=\"code-string\">\"function\"</span>==<span class=\"code-keyword\">typeof</span> define&amp;&amp;define.amd?define([<span class=\"code-string\">\"exports\"</span>,<span class=\"code-string\">\"angular\"</span>],e):e((t=t||self)[<span class=\"code-string\">\"@uirouter/angularjs-state-events\"</span>]={},t.angular)}(<span class=\"code-keyword\">this</span>,<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">t,e</span>)</span>{<span class=\"code-string\">\"use strict\"</span>;<span class=\"code-keyword\">var</span> c,o,r=angular,n=e&amp;&amp;e.module?e:r;<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">s</span>(<span class=\"code-params\">t,e</span>)</span>{<span class=\"code-keyword\">var</span> r,n;<span class=\"code-keyword\">if</span>(<span class=\"code-built_in\">Array</span>.isArray(e)&amp;&amp;(r=e[<span class=\"code-number\">0</span>],n=e[<span class=\"code-number\">1</span>]),!o(r))<span class=\"code-keyword\">throw</span> <span class=\"code-keyword\">new</span> <span class=\"code-built_in\">Error</span>(<span class=\"code-string\">\"invalid parameters to applyPairs\"</span>);<span class=\"code-keyword\">return</span> t[r]=n,t}<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">i</span>(<span class=\"code-params\">e</span>)</span>{<span class=\"code-keyword\">if</span>(e.options().notify&amp;&amp;e.valid()&amp;&amp;!e.ignored()){<span class=\"code-keyword\">var</span> t=e.injector(),r=t.get(<span class=\"code-string\">\"$stateEvents\"</span>),n=t.get(<span class=\"code-string\">\"$rootScope\"</span>),o=t.get(<span class=\"code-string\">\"$state\"</span>),a=t.get(<span class=\"code-string\">\"$urlRouter\"</span>),s=r.provider.enabled(),i=e.params(<span class=\"code-string\">\"to\"</span>),u=e.params(<span class=\"code-string\">\"from\"</span>);<span class=\"code-keyword\">if</span>(s.$stateChangeSuccess){<span class=\"code-keyword\">if</span>(n.$broadcast(<span class=\"code-string\">\"$stateChangeStart\"</span>,e.to(),i,e.from(),u,e.options(),e).defaultPrevented)<span class=\"code-keyword\">return</span> s.$stateChangeCancel&amp;&amp;n.$broadcast(<span class=\"code-string\">\"$stateChangeCancel\"</span>,e.to(),i,e.from(),u,e.options(),e),<span class=\"code-literal\">null</span>==o.transition&amp;&amp;a.update(),!<span class=\"code-number\">1</span>;e.onSuccess({},<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{n.$broadcast(<span class=\"code-string\">\"$stateChangeSuccess\"</span>,e.to(),i,e.from(),u,e.options(),e)},{<span class=\"code-attr\">priority</span>:<span class=\"code-number\">9999</span>})}s.$stateChangeError&amp;&amp;e.promise.catch(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">t</span>)</span>{t&amp;&amp;(<span class=\"code-number\">2</span>===t.type||<span class=\"code-number\">3</span>===t.type)||(n.$broadcast(<span class=\"code-string\">\"$stateChangeError\"</span>,e.to(),i,e.from(),u,t,e.options(),e).defaultPrevented||a.update())})}}<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">u</span>(<span class=\"code-params\">t,e,r</span>)</span>{<span class=\"code-keyword\">var</span> n=r.get(<span class=\"code-string\">\"$state\"</span>),o=r.get(<span class=\"code-string\">\"$rootScope\"</span>),a=r.get(<span class=\"code-string\">\"$urlRouter\"</span>),s={<span class=\"code-attr\">to</span>:t.identifier(),<span class=\"code-attr\">toParams</span>:t.params(),<span class=\"code-attr\">options</span>:t.options()},i=o.$broadcast(<span class=\"code-string\">\"$stateNotFound\"</span>,s,e.state(),e.params());<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">u</span>(<span class=\"code-params\"></span>)</span>{<span class=\"code-keyword\">return</span> n.target(s.to,s.toParams,s.options)}<span class=\"code-keyword\">return</span>(i.defaultPrevented||i.retry)&amp;&amp;a.update(),!i.defaultPrevented&amp;&amp;(i.retry||n.get(s.to)?i.retry&amp;&amp;c(i.retry.then)?i.retry.then(u):u():<span class=\"code-keyword\">void</span> <span class=\"code-number\">0</span>)}<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">d</span>(<span class=\"code-params\">e</span>)</span>{d.prototype.instance=<span class=\"code-keyword\">this</span>;<span class=\"code-keyword\">var</span> r=!<span class=\"code-number\">1</span>,n=[<span class=\"code-string\">\"$stateChangeStart\"</span>,<span class=\"code-string\">\"$stateNotFound\"</span>,<span class=\"code-string\">\"$stateChangeSuccess\"</span>,<span class=\"code-string\">\"$stateChangeError\"</span>],o=n.map(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">t</span>)</span>{<span class=\"code-keyword\">return</span>[t,!<span class=\"code-number\">0</span>]}).reduce(s,{});<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">a</span>(<span class=\"code-params\"></span>)</span>{<span class=\"code-keyword\">if</span>(r)<span class=\"code-keyword\">throw</span> <span class=\"code-keyword\">new</span> <span class=\"code-built_in\">Error</span>(<span class=\"code-string\">\"Cannot enable events at runtime (use $stateEventsProvider\"</span>)}<span class=\"code-function\"><span class=\"code-keyword\">function</span> <span class=\"code-title\">t</span>(<span class=\"code-params\">t</span>)</span>{<span class=\"code-keyword\">return</span> r=!<span class=\"code-number\">0</span>,o.$stateNotFound&amp;&amp;e.onInvalid(u),o.$stateChangeStart&amp;&amp;t.onBefore({},i,{<span class=\"code-attr\">priority</span>:<span class=\"code-number\">1e3</span>}),{<span class=\"code-attr\">provider</span>:d.prototype.instance}}<span class=\"code-keyword\">this</span>.enable=<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{<span class=\"code-keyword\">for</span>(<span class=\"code-keyword\">var</span> t=[],e=<span class=\"code-number\">0</span>;e&lt;<span class=\"code-built_in\">arguments</span>.length;e++)t[e]=<span class=\"code-built_in\">arguments</span>[e];a(),t&amp;&amp;t.length||(t=n),t.forEach(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">t</span>)</span>{<span class=\"code-keyword\">return</span> o[t]=!<span class=\"code-number\">0</span>})},<span class=\"code-keyword\">this</span>.disable=<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{<span class=\"code-keyword\">for</span>(<span class=\"code-keyword\">var</span> t=[],e=<span class=\"code-number\">0</span>;e&lt;<span class=\"code-built_in\">arguments</span>.length;e++)t[e]=<span class=\"code-built_in\">arguments</span>[e];a(),t&amp;&amp;t.length||(t=n),t.forEach(<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\">t</span>)</span>{<span class=\"code-keyword\">return</span> <span class=\"code-keyword\">delete</span> o[t]})},<span class=\"code-keyword\">this</span>.enabled=<span class=\"code-function\"><span class=\"code-keyword\">function</span>(<span class=\"code-params\"></span>)</span>{<span class=\"code-keyword\">return</span> o},(<span class=\"code-keyword\">this</span>.$<span class=\"code-keyword\">get</span>=t).$inject=[\"$transitions\"]}c=n.isFunction,o=n.isString,u.$inject=[\"$to$\",\"$from$\",\"$state\",\"$rootScope\",\"$urlRouter\"],d.$inject=[\"$stateProvider\"],n.module(\"ui.router.state.events\",[\"ui.router.state\"]).provider(\"$stateEvents\",d).run([\"$stateEvents\",function(t){}]),t.$stateChangeCancel=<span class=\"code-keyword\">void</span> <span class=\"code-number\">0</span>,t.$stateChangeError=<span class=\"code-keyword\">void</span> <span class=\"code-number\">0</span>,t.$stateChangeStart=<span class=\"code-keyword\">void</span> <span class=\"code-number\">0</span>,t.$stateChangeSuccess=<span class=\"code-keyword\">void</span> <span class=\"code-number\">0</span>,t.$stateNotFound=<span class=\"code-keyword\">void</span> <span class=\"code-number\">0</span>,<span class=\"code-built_in\">Object</span>.defineProperty(t,<span class=\"code-string\">\"__esModule\"</span>,{<span class=\"code-attr\">value</span>:!<span class=\"code-number\">0</span>})});\n","<span class=\"code-comment\">//# sourceMappingURL=stateEvents.min.js.map</span>\n",""]}}}</script></head><body><div id="root"><style data-emotion-css="262b4o">html{box-sizing:border-box;}*,*:before,*:after{box-sizing:inherit;}html,body,#root{height:100%;margin:0;}body{font-family:-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Cantarell", "Fira Sans", "Droid Sans", "Helvetica Neue", sans-serif;font-size:16px;line-height:1.5;background:white;color:black;}code{font-family:Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace;}th,td{padding:0;}select{font-size:inherit;}#root{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;}</style><style data-emotion-css="1r6h1r6">.code-listing{background:#fbfdff;color:#383a42;}.code-comment,.code-quote{color:#a0a1a7;font-style:italic;}.code-doctag,.code-keyword,.code-link,.code-formula{color:#a626a4;}.code-section,.code-name,.code-selector-tag,.code-deletion,.code-subst{color:#e45649;}.code-literal{color:#0184bb;}.code-string,.code-regexp,.code-addition,.code-attribute,.code-meta-string{color:#50a14f;}.code-built_in,.code-class .code-title{color:#c18401;}.code-attr,.code-variable,.code-template-variable,.code-type,.code-selector-class,.code-selector-attr,.code-selector-pseudo,.code-number{color:#986801;}.code-symbol,.code-bullet,.code-meta,.code-selector-id,.code-title{color:#4078f2;}.code-emphasis{font-style:italic;}.code-strong{font-weight:bold;}</style><style data-emotion-css="1c3h18e">.css-1c3h18e{-webkit-flex:1 0 auto;-ms-flex:1 0 auto;flex:1 0 auto;}</style><div class="css-1c3h18e"><style data-emotion-css="1cfuj1t">.css-1cfuj1t{max-width:940px;padding:0 20px;margin:0 auto;}</style><div class="css-1cfuj1t"><style data-emotion-css="xi606m">.css-xi606m{text-align:center;}</style><header class="css-xi606m"><style data-emotion-css="17kjije">.css-17kjije{font-size:3rem;margin-top:2rem;}</style><h1 class="css-17kjije"><style data-emotion-css="1ydg16i">.css-1ydg16i{color:#000;-webkit-text-decoration:none;text-decoration:none;}</style><a href="/" class="css-1ydg16i">UNPKG</a></h1></header><style data-emotion-css="93o42g">.css-93o42g{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}@media (max-width:700px){.css-93o42g{-webkit-flex-direction:column-reverse;-ms-flex-direction:column-reverse;flex-direction:column-reverse;-webkit-align-items:flex-start;-webkit-box-align:flex-start;-ms-flex-align:flex-start;align-items:flex-start;}}</style><header class="css-93o42g"><style data-emotion-css="k4kplh">.css-k4kplh{font-size:1.5rem;font-weight:normal;-webkit-flex:1;-ms-flex:1;flex:1;}</style><h1 class="css-k4kplh"><nav><span><style data-emotion-css="xt128v">.css-xt128v{color:#0076ff;-webkit-text-decoration:none;text-decoration:none;}.css-xt128v:hover{-webkit-text-decoration:underline;text-decoration:underline;}</style><a href="/browse/@uirouter/angularjs@1.0.26/" class="css-xt128v">@uirouter/angularjs</a></span><span><style data-emotion-css="lllnmq">.css-lllnmq{padding-left:5px;padding-right:5px;}</style><span class="css-lllnmq">/</span><a href="/browse/@uirouter/angularjs@1.0.26/release/" class="css-xt128v">release</a></span><span><span class="css-lllnmq">/</span><strong>stateEvents.min.js</strong></span></nav></h1><style data-emotion-css="1nr3dab">.css-1nr3dab{margin-left:20px;}@media (max-width:700px){.css-1nr3dab{margin-left:0;margin-bottom:0;}}</style><p class="css-1nr3dab"><label>Version:<!-- --> <style data-emotion-css="un3bt6">.css-un3bt6{-webkit-appearance:none;-moz-appearance:none;appearance:none;cursor:pointer;padding:4px 24px 4px 8px;font-weight:600;font-size:0.9em;color:#24292e;border:1px solid rgba(27,31,35,.2);border-radius:3px;background-color:#eff3f6;background-image:url(data:image/png;base64,);background-position:right 8px center;background-repeat:no-repeat;background-size:auto 25%;}.css-un3bt6:hover{background-color:#e6ebf1;border-color:rgba(27,31,35,.35);}.css-un3bt6:active{background-color:#e9ecef;border-color:rgba(27,31,35,.35);box-shadow:inset 0 0.15em 0.3em rgba(27,31,35,.15);}</style><select name="version" class="css-un3bt6"><option value="0.2.8">0.2.8</option><option value="0.2.10">0.2.10</option><option value="0.2.11">0.2.11</option><option value="0.2.13">0.2.13</option><option value="0.2.14">0.2.14</option><option value="0.2.15">0.2.15</option><option value="0.2.16">0.2.16</option><option value="0.2.17">0.2.17</option><option value="0.2.18">0.2.18</option><option value="0.3.0">0.3.0</option><option value="0.3.1">0.3.1</option><option value="0.3.2">0.3.2</option><option value="0.4.0">0.4.0</option><option value="0.4.1">0.4.1</option><option value="0.4.2">0.4.2</option><option value="0.4.3">0.4.3</option><option value="1.0.0">1.0.0</option><option value="1.0.1">1.0.1</option><option value="1.0.3">1.0.3</option><option value="1.0.4">1.0.4</option><option value="1.0.5-SNAPSHOT.20170711">1.0.5-SNAPSHOT.20170711</option><option value="1.0.5">1.0.5</option><option value="1.0.6-SNAPSHOT.20170812">1.0.6-SNAPSHOT.20170812</option><option value="1.0.6">1.0.6</option><option value="1.0.7">1.0.7</option><option value="1.0.8">1.0.8</option><option value="1.0.9">1.0.9</option><option value="1.0.10">1.0.10</option><option value="1.0.11">1.0.11</option><option value="1.0.12">1.0.12</option><option value="1.0.13">1.0.13</option><option value="1.0.14">1.0.14</option><option value="1.0.15">1.0.15</option><option value="1.0.16">1.0.16</option><option value="1.0.17">1.0.17</option><option value="1.0.18">1.0.18</option><option value="1.0.19">1.0.19</option><option value="1.0.20">1.0.20</option><option value="1.0.21">1.0.21</option><option value="1.0.22">1.0.22</option><option value="1.0.23">1.0.23</option><option value="1.0.24">1.0.24</option><option value="1.0.25">1.0.25</option><option selected="" value="1.0.26">1.0.26</option></select></label></p></header></div><style data-emotion-css="107j3ms">.css-107j3ms{max-width:940px;padding:0 20px;margin:0 auto;}@media (max-width:700px){.css-107j3ms{padding:0;margin:0;}}</style><div class="css-107j3ms"><style data-emotion-css="q3frg4">.css-q3frg4{border:1px solid #dfe2e5;border-radius:3px;}@media (max-width:700px){.css-q3frg4{border-right-width:0;border-left-width:0;}}</style><div class="css-q3frg4"><style data-emotion-css="10o5omr">.css-10o5omr{padding:10px;background:#f6f8fa;color:#424242;border:1px solid #d1d5da;border-top-left-radius:3px;border-top-right-radius:3px;margin:-1px -1px 0;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;}@media (max-width:700px){.css-10o5omr{padding-right:20px;padding-left:20px;}}</style><div class="css-10o5omr"><span>3.03 kB</span> <span>JavaScript</span> <style data-emotion-css="12cxnkg">.css-12cxnkg{display:inline-block;-webkit-text-decoration:none;text-decoration:none;padding:2px 8px;font-weight:600;font-size:0.9rem;color:#24292e;background-color:#eff3f6;border:1px solid rgba(27,31,35,.2);border-radius:3px;}.css-12cxnkg:hover{background-color:#e6ebf1;border-color:rgba(27,31,35,.35);}.css-12cxnkg:active{background-color:#e9ecef;border-color:rgba(27,31,35,.35);box-shadow:inset 0 0.15em 0.3em rgba(27,31,35,.15);}</style><a title="stateEvents.min.js" href="/@uirouter/angularjs@1.0.26/release/stateEvents.min.js" class="css-12cxnkg">View Raw</a></div><style data-emotion-css="1i31ihw">.css-1i31ihw{overflow-x:auto;overflow-y:hidden;padding-top:5px;padding-bottom:5px;}</style><div class="code-listing css-1i31ihw"><style data-emotion-css="173nir8">.css-173nir8{border:none;border-collapse:collapse;border-spacing:0;}</style><table class="css-173nir8"><tbody><tr><style data-emotion-css="a4x74f">.css-a4x74f{padding-left:10px;padding-right:10px;color:rgba(27,31,35,.3);text-align:right;vertical-align:top;width:1%;min-width:50px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}</style><td id="L1" class="css-a4x74f"><span>1</span></td><style data-emotion-css="1dcdqdg">.css-1dcdqdg{padding-left:10px;padding-right:10px;color:#24292e;white-space:pre;}</style><td id="LC1" class="css-1dcdqdg"><code><span class="code-comment">/**
...
</span></code></td></tr><tr><td id="L3" class="css-a4x74f"><span>3</span></td><td id="LC3" class="css-1dcdqdg"><code><span class="code-comment"> * @version v1.0.26
</span></code></td></tr><tr><td id="L4" class="css-a4x74f"><span>4</span></td><td id="LC4" class="css-1dcdqdg"><code><span class="code-comment"> * @link https://ui-router.github.io
</span></code></td></tr><tr><td id="L5" class="css-a4x74f"><span>5</span></td><td id="LC5" class="css-1dcdqdg"><code><span class="code-comment"> * @license MIT License, http://www.opensource.org/licenses/MIT
...
</code></td></tr><tr><td id="L7" class="css-a4x74f"><span>7</span></td><td id="LC7" class="css-1dcdqdg"><code>!<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">t,e</span>)</span>{<span class="code-string">"object"</span>==<span class="code-keyword">typeof</span> exports&amp;&amp;<span class="code-string">"undefined"</span>!=<span class="code-keyword">typeof</span> <span class="code-built_in">module</span>?e(exports,<span class="code-built_in">require</span>(<span class="code-string">"angular"</span>)):<span class="code-string">"function"</span>==<span class="code-keyword">typeof</span> define&amp;&amp;define.amd?define([<span class="code-string">"exports"</span>,<span class="code-string">"angular"</span>],e):e((t=t||self)[<span class="code-string">"@uirouter/angularjs-state-events"</span>]={},t.angular)}(<span class="code-keyword">this</span>,<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">t,e</span>)</span>{<span class="code-string">"use strict"</span>;<span class="code-keyword">var</span> c,o,r=angular,n=e&amp;&amp;e.module?e:r;<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">s</span>(<span class="code-params">t,e</span>)</span>{<span class="code-keyword">var</span> r,n;<span class="code-keyword">if</span>(<span class="code-built_in">Array</span>.isArray(e)&amp;&amp;(r=e[<span class="code-number">0</span>],n=e[<span class="code-number">1</span>]),!o(r))<span class="code-keyword">throw</span> <span class="code-keyword">new</span> <span class="code-built_in">Error</span>(<span class="code-string">"invalid parameters to applyPairs"</span>);<span class="code-keyword">return</span> t[r]=n,t}<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">i</span>(<span class="code-params">e</span>)</span>{<span class="code-keyword">if</span>(e.options().notify&amp;&amp;e.valid()&amp;&amp;!e.ignored()){<span class="code-keyword">var</span> t=e.injector(),r=t.get(<span class="code-string">"$stateEvents"</span>),n=t.get(<span class="code-string">"$rootScope"</span>),o=t.get(<span class="code-string">"$state"</span>),a=t.get(<span class="code-string">"$urlRouter"</span>),s=r.provider.enabled(),i=e.params(<span class="code-string">"to"</span>),u=e.params(<span class="code-string">"from"</span>);<span class="code-keyword">if</span>(s.$stateChangeSuccess){<span class="code-keyword">if</span>(n.$broadcast(<span class="code-string">"$stateChangeStart"</span>,e.to(),i,e.from(),u,e.options(),e).defaultPrevented)<span class="code-keyword">return</span> s.$stateChangeCancel&amp;&amp;n.$broadcast(<span class="code-string">"$stateChangeCancel"</span>,e.to(),i,e.from(),u,e.options(),e),<span class="code-literal">null</span>==o.transition&amp;&amp;a.update(),!<span class="code-number">1</span>;e.onSuccess({},<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{n.$broadcast(<span class="code-string">"$stateChangeSuccess"</span>,e.to(),i,e.from(),u,e.options(),e)},{<span class="code-attr">priority</span>:<span class="code-number">9999</span>})}s.$stateChangeError&amp;&amp;e.promise.catch(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">t</span>)</span>{t&amp;&amp;(<span class="code-number">2</span>===t.type||<span class="code-number">3</span>===t.type)||(n.$broadcast(<span class="code-string">"$stateChangeError"</span>,e.to(),i,e.from(),u,t,e.options(),e).defaultPrevented||a.update())})}}<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">u</span>(<span class="code-params">t,e,r</span>)</span>{<span class="code-keyword">var</span> n=r.get(<span class="code-string">"$state"</span>),o=r.get(<span class="code-string">"$rootScope"</span>),a=r.get(<span class="code-string">"$urlRouter"</span>),s={<span class="code-attr">to</span>:t.identifier(),<span class="code-attr">toParams</span>:t.params(),<span class="code-attr">options</span>:t.options()},i=o.$broadcast(<span class="code-string">"$stateNotFound"</span>,s,e.state(),e.params());<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">u</span>(<span class="code-params"></span>)</span>{<span class="code-keyword">return</span> n.target(s.to,s.toParams,s.options)}<span class="code-keyword">return</span>(i.defaultPrevented||i.retry)&amp;&amp;a.update(),!i.defaultPrevented&amp;&amp;(i.retry||n.get(s.to)?i.retry&amp;&amp;c(i.retry.then)?i.retry.then(u):u():<span class="code-keyword">void</span> <span class="code-number">0</span>)}<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">d</span>(<span class="code-params">e</span>)</span>{d.prototype.instance=<span class="code-keyword">this</span>;<span class="code-keyword">var</span> r=!<span class="code-number">1</span>,n=[<span class="code-string">"$stateChangeStart"</span>,<span class="code-string">"$stateNotFound"</span>,<span class="code-string">"$stateChangeSuccess"</span>,<span class="code-string">"$stateChangeError"</span>],o=n.map(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">t</span>)</span>{<span class="code-keyword">return</span>[t,!<span class="code-number">0</span>]}).reduce(s,{});<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">a</span>(<span class="code-params"></span>)</span>{<span class="code-keyword">if</span>(r)<span class="code-keyword">throw</span> <span class="code-keyword">new</span> <span class="code-built_in">Error</span>(<span class="code-string">"Cannot enable events at runtime (use $stateEventsProvider"</span>)}<span class="code-function"><span class="code-keyword">function</span> <span class="code-title">t</span>(<span class="code-params">t</span>)</span>{<span class="code-keyword">return</span> r=!<span class="code-number">0</span>,o.$stateNotFound&amp;&amp;e.onInvalid(u),o.$stateChangeStart&amp;&amp;t.onBefore({},i,{<span class="code-attr">priority</span>:<span class="code-number">1e3</span>}),{<span class="code-attr">provider</span>:d.prototype.instance}}<span class="code-keyword">this</span>.enable=<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{<span class="code-keyword">for</span>(<span class="code-keyword">var</span> t=[],e=<span class="code-number">0</span>;e&lt;<span class="code-built_in">arguments</span>.length;e++)t[e]=<span class="code-built_in">arguments</span>[e];a(),t&amp;&amp;t.length||(t=n),t.forEach(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">t</span>)</span>{<span class="code-keyword">return</span> o[t]=!<span class="code-number">0</span>})},<span class="code-keyword">this</span>.disable=<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{<span class="code-keyword">for</span>(<span class="code-keyword">var</span> t=[],e=<span class="code-number">0</span>;e&lt;<span class="code-built_in">arguments</span>.length;e++)t[e]=<span class="code-built_in">arguments</span>[e];a(),t&amp;&amp;t.length||(t=n),t.forEach(<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params">t</span>)</span>{<span class="code-keyword">return</span> <span class="code-keyword">delete</span> o[t]})},<span class="code-keyword">this</span>.enabled=<span class="code-function"><span class="code-keyword">function</span>(<span class="code-params"></span>)</span>{<span class="code-keyword">return</span> o},(<span class="code-keyword">this</span>.$<span class="code-keyword">get</span>=t).$inject=["$transitions"]}c=n.isFunction,o=n.isString,u.$inject=["$to$","$from$","$state","$rootScope","$urlRouter"],d.$inject=["$stateProvider"],n.module("ui.router.state.events",["ui.router.state"]).provider("$stateEvents",d).run(["$stateEvents",function(t){}]),t.$stateChangeCancel=<span class="code-keyword">void</span> <span class="code-number">0</span>,t.$stateChangeError=<span class="code-keyword">void</span> <span class="code-number">0</span>,t.$stateChangeStart=<span class="code-keyword">void</span> <span class="code-number">0</span>,t.$stateChangeSuccess=<span class="code-keyword">void</span> <span class="code-number">0</span>,t.$stateNotFound=<span class="code-keyword">void</span> <span class="code-number">0</span>,<span class="code-built_in">Object</span>.defineProperty(t,<span class="code-string">"__esModule"</span>,{<span class="code-attr">value</span>:!<span class="code-number">0</span>})});
</code></td></tr><tr><td id="L8" class="css-a4x74f"><span>8</span></td><td id="LC8" class="css-1dcdqdg"><code><span class="code-comment">//# sourceMappingURL=stateEvents.min.js.map</span>
